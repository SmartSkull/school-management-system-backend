...
async function main() {
  ...
  const tables = ['AcademicSession', 'ClassRoom', 'User', 'AttendanceLocation', 'Book', 'Expense', 'Hostel', 'Income', 'LeaveEntitlement', 'OnlineClass', 'PayrollDeduction', 'TransportBus', 'TransportDriver', 'TransportRoute'];
