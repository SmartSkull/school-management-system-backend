...
const { cols, rows } = parseTable('assignment');
console.log('Assignment cols:', cols);
console.log('Assignment rows:', rows.length);
console.log('First row:', rows[0] ? rows[0].slice(0, 5) : 'none');
