...
import { TransportController, DriverController, StudentTransportController } from './transport.controller';
...
@Module({
  ...
  controllers: [TransportController, DriverController, StudentTransportController],
